  ...
  return (
    <div className="fixed inset-0 z-50 flex bg-white">
        ...
        <div className="w-64 bg-neutral-50 border-r border-neutral-200 flex flex-col">
          <div className="p-4 border-b border-neutral-200">
            <button
              ...
              className="w-full py-2 px-4 text-sm font-medium text-white bg-secondary-600 rounded-lg hover:bg-secondary-700 transition-colors flex items-center justify-center gap-2"
            >
          ...
          <div className="flex-1 overflow-y-auto">
            {conversations.length === 0 ? (
              ...
              conversations.map(convo => (
                <div
                  key={convo.id}
                  className={`group flex items-center gap-2 p-3 cursor-pointer border-b border-gray-100 hover:bg-neutral-100 transition-colors ${
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-neutral-900 truncate">{convo.title}</p>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-neutral-200 bg-white">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h2 className="font-semibold text-neutral-900">Research Partner</h2>
                <p className="text-xs text-neutral-500">Ask questions about your notes</p>
              </div>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`p-2 rounded transition-colors ${
                showInsights
                  ? 'text-secondary-600 bg-indigo-50'
            ...
            <div className="relative">
              ...
              {showToolsMenu && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-neutral-200 py-1 z-10">
                  <button
            ...
            <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-md mx-4">
              ...
              <div className="flex justify-end gap-3 mt-6">
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium text-neutral-700 bg-neutral-100 rounded-lg hover:bg-gray-200"
                >
                  Cancel
                </button>
                <button
                ...
                <div className="grid grid-cols-1 gap-2 text-sm">
                  {[
                    ...
                    <button
                      ...
                      className="px-3 py-2 text-left text-neutral-600 bg-neutral-100 rounded-lg hover:bg-gray-200 transition-colors"
                    >
                      "{example}"
                    </button>
                  ))}
                    ...
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: formatMessage(msg.content)
                          .replace(/\n/g, '<br>')
                          .replace(/<span class="citation"/g, '<span class="text-secondary-600 font-medium cursor-pointer hover:underline"')
                      }}
                    />
                        ...
                        <div className="flex flex-wrap gap-2">
                          {msg.citations.map((cite, i) => (
                            <button
                              ...
                              className="text-xs px-2 py-1 bg-white text-secondary-600 rounded border border-indigo-200 hover:bg-indigo-50 transition-colors"
                            >
                              {cite.noteTitle}
                            </button>
                          ))}
        ...
        {/* Error message */}
        {error && (
          <div className="mx-4 mb-2 p-3 bg-red-50 border border-red-200 rounded-lg text-sm text-error-600">
            {error}
          </div>
        )}
            ...
            <div className="space-y-1">
              {extractedTasks.map(task => (
                <div key={task.id} className="flex items-center justify-between gap-2 text-sm">
                  <span className="text-neutral-700 flex-1">{task.task}</span>
                  ...
                  <button
                    ...
                    className="px-2 py-1 text-xs text-secondary-600 hover:bg-purple-100 rounded transition-colors"
                  >
                    Add as note
                  </button>
                </div>
          ...
          <div className="border-t border-neutral-200 p-4">
            <div className="flex gap-3">
              <textarea
                ...
                rows={1}
                className="flex-1 px-4 py-2 border border-neutral-300 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"
              />
              <button
                onClick={handleSend}
                disabled={!input.trim() || !isAvailable || loading}
                className="px-4 py-2 text-white bg-secondary-600 rounded-lg hover:bg-secondary-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
