      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-neutral-200 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-neutral-900">Share Note</h2>
              <p className="text-sm text-neutral-500 truncate max-w-[200px]">{noteTitle}</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-5">
          {!available ? (
            <div className="text-center py-6">
              ...
              <h3 className="font-medium text-neutral-900 mb-1">Sync Required</h3>
            ...
            <div className="flex items-center justify-center py-8">
              <svg className="w-6 h-6 animate-spin text-secondary-600" fill="none" viewBox="0 0 24 24">
              ...
              {isShared && shareUrl ? (
                <>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        value={shareUrl}
                        readOnly
                        className="flex-1 px-3 py-2 text-sm bg-neutral-50 border border-neutral-300 rounded-lg focus:outline-none"
                      />
                      <button
                  ...
                  <button
                    ...
                    className="w-full py-2 px-4 text-sm font-medium text-error-600 bg-red-50 border border-red-200 rounded-lg hover:bg-red-100 transition-colors"
                  >
                    Revoke Share Link
                  </button>
                </>
                ...
                <>
                  ...
                  <div className="text-center py-4">
                    ...
                    <h3 className="font-medium text-neutral-900 mb-2">This note is private</h3>
                    <p className="text-sm text-neutral-500 mb-6">
                      Create a shareable link to let anyone view this note.
                    </p>
                    <button
                      onClick={handleEnableSharing}
                      className="px-6 py-2.5 text-sm font-medium text-white bg-secondary-600 rounded-lg hover:bg-secondary-700 transition-colors"
                    >
                      Create Share Link
                    </button>
                  </div>
